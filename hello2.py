    ...
    "cells": [
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": "# Final Project: Data Science Basics & tools for data science"
        },
        {
            "cell_type": "markdown",
            "metadata": {},
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": "## GitHub Link\nYou can find the notebook on [GitHub](https://github.com/dhruviklathiya/IBM-data-science-coursera)."
        },
        {
            "cell_type": "code",
